...
const BuyTicket = ({ tier, setAlert, onSuccess }) => {
  ...
  return (
    <div style={{ marginTop: '2.5rem' }}>
      ...
      {sponsorFee && (
        <p style={{ textAlign: 'center', fontSize: '0.75rem', color: 'var(--primary)', marginTop: '0.4rem', fontWeight: 600 }}>
          ℹ️ Platform will cover your network fee — no XLM balance needed for gas.
        </p>
      )}
